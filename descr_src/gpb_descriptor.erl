...
-export_type(['UninterpretedOption.NamePart'/0, 'UninterpretedOption'/0, 'ServiceOptions'/0, 'MethodOptions'/0, 'MethodDescriptorProto'/0, 'ServiceDescriptorProto'/0, 'SourceCodeInfo.Location'/0, 'EnumOptions'/0, 'EnumValueOptions'/0, 'EnumValueDescriptorProto'/0, 'EnumDescriptorProto'/0, 'GeneratedCodeInfo.Annotation'/0, 'GeneratedCodeInfo'/0, 'DescriptorProto.ExtensionRange'/0, 'MessageOptions'/0, 'DescriptorProto.ReservedRange'/0, 'OneofDescriptorProto'/0, 'FieldOptions'/0, 'FieldDescriptorProto'/0, 'DescriptorProto'/0, 'FileOptions'/0, 'SourceCodeInfo'/0, 'FileDescriptorProto'/0, 'FileDescriptorSet'/0]).

-spec encode_msg(#'UninterpretedOption.NamePart'{} | #'UninterpretedOption'{} | #'ServiceOptions'{} | #'MethodOptions'{} | #'MethodDescriptorProto'{} | #'ServiceDescriptorProto'{} | #'SourceCodeInfo.Location'{} | #'EnumOptions'{} | #'EnumValueOptions'{} | #'EnumValueDescriptorProto'{} | #'EnumDescriptorProto'{} | #'GeneratedCodeInfo.Annotation'{} | #'GeneratedCodeInfo'{} | #'DescriptorProto.ExtensionRange'{} | #'MessageOptions'{} | #'DescriptorProto.ReservedRange'{} | #'OneofDescriptorProto'{} | #'FieldOptions'{} | #'FieldDescriptorProto'{} | #'DescriptorProto'{} | #'FileOptions'{} | #'SourceCodeInfo'{} | #'FileDescriptorProto'{} | #'FileDescriptorSet'{}) -> binary().
...
get_msg_names() ->
    ['UninterpretedOption.NamePart', 'UninterpretedOption',
     ...
     'SourceCodeInfo.Location', 'EnumOptions',
     'EnumValueOptions', 'EnumValueDescriptorProto',
     'EnumDescriptorProto', 'GeneratedCodeInfo.Annotation',
     'GeneratedCodeInfo', 'DescriptorProto.ExtensionRange',
     'MessageOptions', 'DescriptorProto.ReservedRange',
     'OneofDescriptorProto', 'FieldOptions',
     'FieldDescriptorProto', 'DescriptorProto',
     'FileOptions', 'SourceCodeInfo', 'FileDescriptorProto',
     'FileDescriptorSet'].
